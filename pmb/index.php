...
// ambil data dari form login yang disumbit oleh user
$username = $_POST['username'];
$password = $_POST['password'];

// validasi username dan password yang di sumbit oleh user
// lakukan perbandingan dengan nilai hard-code atau username dan password nya 
if ($username == "admin" && $password == '12345'){
// jika nilai username dan password yang di inputkan user sama dengan nilai yang di tetukan 
...
// jika username dan pasword berbeda, redirect atau tetap di halaman index.php/login
